...
class Services {
    ...
    return Row(
      ...
      children: [
        Expanded(
            child: Image(
          image: NetworkImage(
              "https://www.fonafe.gob.pe/pw_content/empresas/17/Img/BancoNacion.png?535792785"),
          height: size! + 10,
        )),
      ],
    );
  ...
  Widget splashlogo(double? size, Color? color) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Expanded(
            child: Image(
          image: NetworkImage("https://i.postimg.cc/RVm1gfqp/Banco-Nacion.png"),
          height: size,
        )),
      ],
    );
